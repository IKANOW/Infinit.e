...
public class NativeCrc32 {
  ...
  public static void calculateChunkedSumsByteArray(int bytesPerSum,
	  ...
	  // Do nothing, just return - checksums disabled
//	  try {
//		  ByteBuffer b1 = ByteBuffer.allocateDirect(sums.length);
//		  b1.put(sums, sumsOffset, sums.length);
//		  ByteBuffer b2 = ByteBuffer.allocateDirect(dataLength);
//		  b2.put(data, dataOffset, dataLength);
//		  
//		nativeVerifyChunkedSums(bytesPerSum, checksumType,
//				  b1, sumsOffset,
//		            b2, dataOffset, dataLength,
//		            "", 0);
//	} catch (ChecksumException e) {
//		throw new RuntimeException("calculateChunkedSumsByteArray", e);
//	}

// Don't have a hadoop.dll that supports this:	  
//    nativeComputeChunkedSumsByteArray(bytesPerSum, checksumType,
//        sums, sumsOffset,
//        data, dataOffset, dataLength,
//        "", 0, false);
