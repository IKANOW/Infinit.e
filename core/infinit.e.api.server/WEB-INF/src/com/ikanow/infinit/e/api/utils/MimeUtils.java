...
public class MimeUtils {
  ...
  public static final String MIME_APPLICATION_VND_MSEXCEL_PLUS = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
  public static final String MIME_APPLICATION_VND_MSPOWERPOINT_PLUS = "application/vnd.openxmlformats-officedocument.presentationml.slideshow";
  public static final String MIME_APPLICATION_VND_MSPOWERPOINT_SLIDESHOW_PLUS = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
  public static final String MIME_APPLICATION_MSWORD_PLUS = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
  ...
  static {
    mimeTypeMapping = new HashMap<String, String>(200) {
      ...
      put1("xlsx", MIME_APPLICATION_VND_MSEXCEL_PLUS);
      put1("pptx", MIME_APPLICATION_VND_MSPOWERPOINT_PLUS);
      put1("ppsx", MIME_APPLICATION_VND_MSPOWERPOINT_SLIDESHOW_PLUS);
      put1("docx", MIME_APPLICATION_MSWORD_PLUS);
    }};
  }
