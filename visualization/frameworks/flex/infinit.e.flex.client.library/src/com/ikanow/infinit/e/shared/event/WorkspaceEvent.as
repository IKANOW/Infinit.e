...
package com.ikanow.infinit.e.shared.event
{
	...
	public class WorkspaceEvent extends Event
	{
		...
		public static const REPLACE_WIDGET:String = "replaceWidgetEvent";
		...
		public var widgetToReplace:Widget;
		...
		public function WorkspaceEvent( type:String, widget:Widget = null, index:int = WidgetConstants.USE_NEXT_AVAILABLE_INDEX, widgetToReplace:Widget = null )
		{
			super( type, true, false );
			
			this.widget = widget;
			this.index = index;
			this.widgetToReplace = widgetToReplace;
		}
		...
		{
			return new WorkspaceEvent( type, widget, index, widgetToReplace );
		}
	}
}
