...
//TODO going to use Kundera (may not bother including JARs, force user to do that)
 ...
 * @author cmorgan
 */
public class NoSqlHarvester implements HarvesterInterface 
{
	...
	private static final Logger logger = Logger.getLogger(NoSqlHarvester.class);
