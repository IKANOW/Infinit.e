...
private String listItems(HttpServletRequest request, HttpServletResponse response)
{
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	{	
      ...
      out.write("\t<title>Infinit.e.Manager - Community Members</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\n");
	...
	else
	{
      ...
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<td class=\"headerLink\">Members</td>\n");
      ...
      out.write("\t\t\t<table class=\"standardTable\" cellpadding=\"5\" cellspacing=\"1\" width=\"100%\">\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<td class=\"headerLink\">Edit Selected Member</td>\n");
      ...
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Community:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"communities.jsp?action=edit&communityid=");
      out.print(communityid );
      out.write("\" title=\"Return to ");
      out.print(communityName );
      out.write('"');
      out.write('>');
      out.print(communityName );
      out.write("</a>\n");
      ...
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Member Id:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">");
      out.print(personid );
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Member Name:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Email:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">");
      out.print(email);
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Member Type:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">");
      out.print(userTypeControl );
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"30%\">Membership Status:</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#ffffff\" width=\"70%\">");
      out.print(userStatusControl );
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr valign=\"top\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"publishQueriesToActivityFeed\" READONLY /> User Queries are Published to Activity Feed</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"publishLoginToActivityFeed\" READONLY /> User Login Published to Activity Feed</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"publishSharingToActivityFeed\" READONLY /> User Shares Published to Activity Feed</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"publishCommentsToActivityFeed\" READONLY /> User Comments Published to Activity Feed</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"checkbox\" name=\"publishCommentsPublicly\" READONLY /> User Comments are Public</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>* Note: The user attribute functionality is not yet implemented within Infinit.e.</td>\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t</table>\n");
      out.write("\t\t\t\t\t\t</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
	...
	if (personid.length() > 0) {
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<button name=\"updateMember\" value=\"updateMember\">Update Member</button>\n");
