...
EXTRA_JAVA_ARGS="$JAVA_OPTS -Dfile.encoding=UTF-8 -classpath $LIB/infinit.e.data_model.jar:$LIB/infinit.e.harvest.library.jar:$LIB/infinit.e.query.library.jar:$LIB/infinit.e.processing.custom.library.jar:$LIB/infinit.e.processing.generic.library.jar:$LIB/infinit.e.core.server.jar:$LIB/unbundled/*:$LIB/es-libs/*:/opt/hadoop-infinite/lib/*"
