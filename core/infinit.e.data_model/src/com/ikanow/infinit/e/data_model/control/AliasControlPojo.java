...
// THIS IS CURRENTLY A COPY OF EntityFeaturePojo - OVER TIME NEED TO MIGRATE

public class AliasControlPojo  extends BaseApiPojo
{
	// Standard static function for readability
	@SuppressWarnings("unchecked")
	static public TypeToken<List<AliasControlPojo>> listType() { return new TypeToken<List<AliasControlPojo>>(){}; }
	
	// 0] Alias specific fields:
	
	public enum AliasType { AliasReplace, AliasTag, EntityDiscard, DocumentDiscard };
	private AliasType aliasType = null; // (defaults to AliasReplace, currently unused)
	
	// 1] FIELDS ACTUALLY USED IN FOR ALIAS CONTROLS

	// 1.1] ALIAS MASTER INFO:
	...
	// 1.1.2] ALIAS MASTER INFO - GEO SPECIFIC
