...
package com.ikanow.infinit.e.widget.library.utility 
{
	...
	{
		static private var entityMap2:Object = { 
			'&quot;': '34', '&amp;': '38', '&lt;': '60', '&gt;': '62', '&nbsp;':'160', 
		...
		static private var regexHtmlRemove1:RegExp = new RegExp("<br>", "gi");
		static private var regexHtmlRemove2:RegExp = new RegExp("<[^>]*>", "gi");
		/**
		 * Decodes html character codes and returns the new string.
		 * @param str The string to decode
		 * @return A string not containing html codes.
		 */
		static public function convertEntities_txt(str:String, removeTags:Boolean = false):String 
		{
			var re:RegExp = /&\w*;/g
			...
			if (removeTags) {
				return str.replace(regexHtmlRemove1, "\n").replace(regexHtmlRemove2, "");
			}
