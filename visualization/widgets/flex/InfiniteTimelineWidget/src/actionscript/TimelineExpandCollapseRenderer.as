		...
		*/
		public function set expanded(value:Boolean):void
		{
			if (value != _expanded) {
				_expanded = value;
				if (value) {
					if ( InfiniteTimelineWidget.lastExpanded != null) {
						InfiniteTimelineWidget.lastExpanded.expanded = false;
					}
					InfiniteTimelineWidget.lastExpanded = this;
				} else if (InfiniteTimelineWidget.lastExpanded == this) {
					InfiniteTimelineWidget.lastExpanded = null;
				}
